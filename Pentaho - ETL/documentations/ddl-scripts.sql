...
DROP TABLE IF EXISTS stage_db.stg_customer;
CREATE TABLE stage_db.stg_customer (
...
DROP TABLE IF EXISTS stage_db.stg_address;
CREATE TABLE stage_db.stg_address (
...
DROP TABLE IF EXISTS datamart_db.dim_address;
CREATE TABLE datamart_db.dim_address (
  address_skey INT(11) NOT NULL,
  city VARCHAR(255) NOT NULL,
  postal_code VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (address_skey)
...
CREATE TABLE datamart_db.fact_orders (
  ...
  address_skey INT(11) DEFAULT NULL,
  ...
  KEY fk_address_skey (address_skey),
  KEY fk_customer_skey (customer_skey),
  ...
  CONSTRAINT fk_address_skey FOREIGN KEY (address_skey) REFERENCES dim_address (address_skey),
